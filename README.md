...
1. Реализована функция, которая принимает на вход путь до JSON-файла и возвращает список словарей с данными
   ...
   Функцию находится в модуле **utils**. Файл с данными о финансовых транзакциях **operations.json** помещен в
...
3. Функция конвертации помещена в модуль **external_api**.
...
5. Создан модуль **test_utils.py**, где реализовано тестирование используя **Mock** и **patch**.